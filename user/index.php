...
';
	 ...
	 if(isset($_POST['userID'])){ //post array value same or not
		$userID = $_POST['userID']; //Stored in session then passed in header input,now here
		...
		{
			$_SESSION['save _life_date']=$crntDate; //to update date and insert new value
				...
				<div class="panel panel-default" style="padding: 20px;">
					<div class="panel-body">
						...
						<div class="alert alert-danger alert-dismissable" style="font-size: 18px; display: none;">
							...
							<?php
							$safeDate = $_SESSION['save _life_date'];
							...
							$diffMonth =$diff->m;
								...
								<span>You have already save a life. You will donate the blood after three months. We are very thankful to you.</span>
							</div>';
								}
